...
abstract class RecyclerViewBaseAdapter() :
    RecyclerView.Adapter<BaseRecyclerViewHolder>(), LifecycleObserver {
    ...
    protected abstract fun viewHolder(@LayoutRes layout: Int, view: View): BaseRecyclerViewHolder
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, @LayoutRes layout: Int): BaseRecyclerViewHolder {
